...
for _ in range(10000):
    play_and_record(agent, env1, exp_replay, n_steps=1)
    play_and_record(agent, env2, exp_replay, n_steps=1)
    play_and_record(agent, env3, exp_replay, n_steps=1)
    play_and_record(agent, env4, exp_replay, n_steps=1)
    play_and_record(agent, env5, exp_replay, n_steps=1)
    play_and_record(agent, env6, exp_replay, n_steps=1)
    play_and_record(agent, env7, exp_replay, n_steps=1)
...
def train():
    _, loss_t = sess.run([train_step, td_loss], sample_batch(exp_replay, batch_size=256)) 
...
for i in trange(10**6):
    ...
    #s = env.restore_pose()
    for _ in range(1):
        play_and_record(agent, env1, exp_replay, 1)
        play_and_record(agent, env2, exp_replay, 1)
        play_and_record(agent, env3, exp_replay, 1)
        play_and_record(agent, env4, exp_replay, 1)
        play_and_record(agent, env5, exp_replay, 1)
        play_and_record(agent, env6, exp_replay, 1)
        play_and_record(agent, env7, exp_replay, 1)
    #env.set_prev_pose()
