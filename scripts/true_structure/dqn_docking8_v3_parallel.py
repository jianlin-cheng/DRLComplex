...
exp_replay1 = ReplayMemory(15000)
...
play_and_record(agent, env1, exp_replay1, n_steps=10000)
play_and_record(agent, env2, exp_replay2, n_steps=10000)
play_and_record(agent, env3, exp_replay3, n_steps=10000)
play_and_record(agent, env4, exp_replay4, n_steps=10000)
play_and_record(agent, env5, exp_replay5, n_steps=10000)
play_and_record(agent, env6, exp_replay6, n_steps=10000)
play_and_record(agent, env7, exp_replay7, n_steps=10000)
...
for i in trange(10**6):
    ...
    play_and_record(agent, env2, exp_replay2, 10)
    play_and_record(agent, env3, exp_replay3, 10)
    play_and_record(agent, env4, exp_replay4, 10)
    play_and_record(agent, env5, exp_replay5, 10)
    play_and_record(agent, env6, exp_replay6, 10)
    play_and_record(agent, env7, exp_replay7, 10)
    #env.set_prev_pose()
